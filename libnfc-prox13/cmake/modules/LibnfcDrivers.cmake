...
SET(LIBNFC_DRIVER_PROX13 ON CACHE BOOL "Enable PROX 13 MHz Reader support (Use serial port)")
...
# --- PROX 13 MHz Reader ---
IF(LIBNFC_DRIVER_PROX13)
  ADD_DEFINITIONS("-DDRIVER_PROX13_ENABLED")
  SET(DRIVERS_SOURCES ${DRIVERS_SOURCES} "drivers/prox13.c")
  SET(UART_REQUIRED TRUE)
ENDIF(LIBNFC_DRIVER_PROX13)
